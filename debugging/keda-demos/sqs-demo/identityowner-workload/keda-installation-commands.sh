...
export KEDA_DEMO_APP_SA_ROLENAME=keda-nginxdemo-role-tig-6351


echo ${KEDA_NAMESPACE}
echo ${KEDA_OPERATOR_ROLENAME}
echo ${KEDA_DEMO_APP_SA_ROLENAME}
...
aws iam create-role --role-name ${KEDA_OPERATOR_ROLENAME} --assume-role-policy-document file://./examples/fargate/keda-demos/sqs-demo/identityowner-workload/trust-policy-keda-operator.json
...
aws iam create-role --role-name ${KEDA_DEMO_APP_SA_ROLENAME} --assume-role-policy-document file://./examples/fargate/keda-demos/sqs-demo/identityowner-workload/trust-policy-pod-service-account.json
aws iam create-policy --policy-name ${KDA_SQS_GET_ATTRIBUTES_POLICY} --policy-document file://./examples/fargate/keda-demos/sqs-demo/identityowner-workload/keda-sqs-policy.json
aws iam attach-role-policy --role-name ${KEDA_DEMO_APP_SA_ROLENAME} --policy-arn "arn:aws:iam::545444110299:policy/${KDA_SQS_GET_ATTRIBUTES_POLICY}"

# create pod service account
kubectl apply -n ${KEDA_NAMESPACE}  -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/pod-identity-config.yml
#=========================================================
...
helm install keda kedacore/keda --namespace ${KEDA_NAMESPACE} -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/keda-values-v2-15-irsa.yaml
...
kubectl apply -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/nginx-deployment.yml 
kubectl apply -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/sqs-scaler.yml

kubectl delete -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/sqs-scaler.yml

#KEDA using different role than operator role
kubectl apply -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/pod-identity-config.yml
kubectl delete -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/sqs-scaler-keda-using-sqs-access-role-arn.yml

# Push the messages into the sqs queue, and verify if its dpeloyment is autoscaling based on the messages in the sqs queue.
C:\devwork\eks\terraform-aws-eks\examples\fargate\keda-demos\sqs-demo\identityowner-workload\sqs-scaler-by-role-from-secret.yml
#=========================================================
# Cleanup after the demo
#=========================================================
# delete the deployment and sqs scaler.
kubectl delete -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/nginx-deployment.yml 
kubectl delete -n keda -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/sqs-scaler-by-role-from-secret.yml

kubectl delete -n ${KEDA_NAMESPACE}  -f ./examples/fargate/keda-demos/sqs-demo/identityowner-workload/pod-identity-config.yml

# aws iam detach-role-policy --role-name ${KEDA_DEMO_APP_SA_ROLENAME} --policy-arn "arn:aws:iam::545444110299:policy/${KDA_SQS_GET_ATTRIBUTES_POLICY}"
aws iam delete-role --role-name ${KEDA_DEMO_APP_SA_ROLENAME}
