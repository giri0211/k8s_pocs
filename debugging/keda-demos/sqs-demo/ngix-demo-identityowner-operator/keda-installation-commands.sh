...
kubectl apply -n keda -f ./examples/fargate/keda-demos/sqs-demo/ngix-demo-identityowner-operator/nginx-deployment.yml 
kubectl apply -n keda -f ./examples/fargate/keda-demos/sqs-demo/ngix-demo-identityowner-operator/sqs-scaler.yml
...
kubectl delete -f ./examples/fargate/keda-demos/sqs-demo/ngix-demo-identityowner-operator/nginx-deployment.yml 
kubectl delete -f ./examples/fargate/keda-demos/sqs-demo/ngix-demo-identityowner-operator/sqs-scaler.yml
