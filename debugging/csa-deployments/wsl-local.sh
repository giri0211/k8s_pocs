...
terragrunt apply --terragrunt-config ./aws/phr-sandbox/us-east-1/tig-5485-test-c1.hcl -terragrunt-non-interactive  plan-wsl.out


aws eks --region us-east-1 update-kubeconfig --name tig-5485-test-c1